...
Patch1: BZ-592206-versionlock.patch
Patch2: BZ-592943-repodiff.patch
Patch3: BZ-536911-yum-config-manager.patch 
Patch4: BZ-594646-yum-builddep-multilib.patch
Patch5: BZ-587288-repomanage-bad-path.patch
Patch6: BZ-536770-updateonboot-ret-codes.patch
URL: http://yum.baseurl.org/download/yum-utils/
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
BuildArch: noarch
Requires: python >= 2.4 , yum >= 3.2.25-10
